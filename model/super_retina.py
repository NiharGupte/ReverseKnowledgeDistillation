...
class SuperRetinaTeacher(nn.Module):
...
#         print("Forward of OG code")
    ...
    def forward1(self, x, label_point_positions=None, value_map=None, learn_index=None):
        """
        ...
        """
#         print("Forward of OG code")
        detector_pred, descriptor_pred = self.network1(x)
