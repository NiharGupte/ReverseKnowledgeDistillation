...
#         self.conv2d = torch.nn.Conv2d(c2, c2, kernel_size=7, stride=1, padding=3)
...
#         self.conv3d = torch.nn.Conv2d(c3, c3, kernel_size=7, stride=1, padding=3)
...
#         self.conv4d = torch.nn.Conv2d(c4, c4, kernel_size=7, stride=1, padding=3)
