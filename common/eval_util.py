...
def compute_auc(s_error, p_error, a_error):
    assert (len(s_error) == 71)  # Easy pairs 71
    assert (len(p_error) == 48)  # Hard pairs. Note file control_points_P37_1_2.txt is ignored 48
    assert (len(a_error) == 14)  # Moderate pairs 14
